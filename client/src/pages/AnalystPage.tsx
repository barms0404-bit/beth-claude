...
const analystDatabase: Record<string, AnalystData> = {
  ...
  "samira-arikat": {
    ...
    bio: "Samira Arikat is Managing Partner and Co-Founder of Armstrong Arikat Private Wealth Group, leading the Financial Planning division. She oversees estate planning, tax optimization, retirement strategies, insurance, and wealth transfer for the firm's ultra-high-net-worth clients. CFP, ChFC, CLU certified. MBA from Thunderbird School of Global Management with concentration in International Finance. BA Economics from University of Jordan. 20+ years in wealth management spanning Morgan Stanley Private Wealth, Goldman Sachs Private Client Services, and now Armstrong Arikat.",
  ...
  "omar-hamze": {
    ...
    bio: "Omar Hamze is an Advisor in Training at Armstrong Arikat Private Wealth Group, serving as Beth's executive assistant. He supports Beth with research coordination, data compilation, report formatting, and operational tasks. Currently pursuing Series 65 and CFP certifications. BS Finance from Arizona State University (W.P. Carey School of Business). Omar is learning the firm's investment process from the ground up and is not authorized to make investment decisions or client recommendations independently.",
